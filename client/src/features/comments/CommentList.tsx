  ...
  return (
    <div className="flex gap-4 p-6 bg-white rounded-lg border border-brand-200">
      {comment.author.avatar ? (
        ...
        <div className="w-12 h-12 rounded-full bg-accent-lavender/20 flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-brand-700 leading-relaxed whitespace-pre-wrap">{comment.content}</p>
      </div>
    </div>
  )
}
