...
export function Navbar() {
  return (
    <nav className="bg-white/80 backdrop-blur-md border-b border-brand-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-6">
            <Link 
              to="/" 
              className="text-brand-700 hover:text-accent-coral transition-colors font-medium"
            >
              Stories
            </Link>
            <a 
