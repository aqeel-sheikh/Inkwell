...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', isLoading, fullWidth, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      danger: 'bg-danger-DEFAULT text-white hover:bg-danger-dark focus:ring-danger-light',
      success: 'bg-success-DEFAULT text-white hover:bg-success-dark focus:ring-success-light',
    }
